...
def load_images(path, shape):
    images_01, file_names_01 = read_all_images_in_path(path+"imgs_part_1", shape)
    images_02, file_names_02 = read_all_images_in_path(path+"imgs_part_2", shape)
    images_03, file_names_03 = read_all_images_in_path(path+"imgs_part_3", shape)
